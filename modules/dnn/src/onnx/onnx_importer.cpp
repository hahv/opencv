...
class ONNXImporter {
    ...
    struct LayerInfo {
        int layerId;
        int outputId;
        LayerInfo(int _layerId = 0, int _outputId = 0)
            : layerId(_layerId), outputId(_outputId) {}
    };
    ...
    void expandMid(const std::string& prefix,
                   opencv_onnx::NodeProto& node_proto, const std::string& input,
                   size_t n);
    void addNegation(const LayerParams& layerParams,
                     opencv_onnx::NodeProto& node_proto, int input_id);
   ...
   protected:
    ...
    std::map<std::string, MatShape>
        outShapes;          // List of internal blobs shapes.
   ...
   private:
    typedef void (ONNXImporter::*ONNXImporterNodeParser)(
    ...
    void parseArg(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseMaxUnpool(LayerParams& layerParams,
                        const opencv_onnx::NodeProto& node_proto);
    void parseMaxPool(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parseAveragePool(LayerParams& layerParams,
                          const opencv_onnx::NodeProto& node_proto);
    void parseReduce(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseSlice(LayerParams& layerParams,
                    const opencv_onnx::NodeProto& node_proto);
    void parseSplit(LayerParams& layerParams,
                    const opencv_onnx::NodeProto& node_proto);
    void parseBias(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parsePow(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseMinMax(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseNeg(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseConstant(LayerParams& layerParams,
                       const opencv_onnx::NodeProto& node_proto);
    void parseLSTM(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseGRU(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseImageScaler(LayerParams& layerParams,
                          const opencv_onnx::NodeProto& node_proto);
    void parseClip(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseLeakyRelu(LayerParams& layerParams,
                        const opencv_onnx::NodeProto& node_proto);
    void parseRelu(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseElu(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseTanh(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseAbs(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseCompare(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parsePRelu(LayerParams& layerParams,
                    const opencv_onnx::NodeProto& node_proto);
    void parseLRN(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseInstanceNormalization(LayerParams& layerParams,
                                    const opencv_onnx::NodeProto& node_proto);
    void parseBatchNormalization(LayerParams& layerParams,
                                 const opencv_onnx::NodeProto& node_proto);
    void parseGemm(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseMatMul(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseMul(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseConv(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseConvTranspose(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto);
    void parseTranspose(LayerParams& layerParams,
                        const opencv_onnx::NodeProto& node_proto);
    void parseSqueeze(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parseFlatten(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parseUnsqueeze(LayerParams& layerParams,
                        const opencv_onnx::NodeProto& node_proto);
    void parseExpand(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseReshape(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parsePad(LayerParams& layerParams,
                  const opencv_onnx::NodeProto& node_proto);
    void parseShape(LayerParams& layerParams,
                    const opencv_onnx::NodeProto& node_proto);
    void parseCast(LayerParams& layerParams,
                   const opencv_onnx::NodeProto& node_proto);
    void parseConstantFill(LayerParams& layerParams,
                           const opencv_onnx::NodeProto& node_proto);
    void parseGather(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseConcat(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseResize(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);
    void parseUpsample(LayerParams& layerParams,
                       const opencv_onnx::NodeProto& node_proto);
    void parseSoftMax(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parseDetectionOutput(LayerParams& layerParams,
                              const opencv_onnx::NodeProto& node_proto);
    void parseCumSum(LayerParams& layerParams,
                     const opencv_onnx::NodeProto& node_proto);

    // Domain: com.microsoft
    // URL:
    // https://github.com/microsoft/onnxruntime/blob/master/docs/ContribOperators.md
    void parseQuantDequant(LayerParams& layerParams,
                           const opencv_onnx::NodeProto& node_proto);
    void parseQConv(LayerParams& layerParams,
                    const opencv_onnx::NodeProto& node_proto);
    void parseQMatMul(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);
    void parseQEltwise(LayerParams& layerParams,
                       const opencv_onnx::NodeProto& node_proto);
    void parseQLeakyRelu(LayerParams& layerParams,
                         const opencv_onnx::NodeProto& node_proto);
    void parseQSigmoid(LayerParams& layerParams,
                       const opencv_onnx::NodeProto& node_proto);
    void parseQAvgPool(LayerParams& layerParams,
                       const opencv_onnx::NodeProto& node_proto);
    void parseQConcat(LayerParams& layerParams,
                      const opencv_onnx::NodeProto& node_proto);

    // '???' domain or '???' layer type
    void parseCustomLayer(LayerParams& layerParams,
                          const opencv_onnx::NodeProto& node_proto);
...
ONNXImporter::ONNXImporter(Net& net, const char* onnxFile)
    : missingLayerHandler(DNN_DIAGNOSTICS_RUN ? new detail::LayerHandler()
                                              : nullptr),
      dstNet(net),
      onnx_opset(0) {
    ...
    CV_Assert(onnxFile);
    CV_LOG_DEBUG(NULL,
                 "DNN/ONNX: processing ONNX model from file: " << onnxFile);

    std::fstream input(onnxFile, std::ios::in | std::ios::binary);
    if (!input) {
        CV_Error(Error::StsBadArg,
                 cv::format("Can't read ONNX file: %s", onnxFile));
    }

    if (!model_proto.ParseFromIstream(&input)) {
        CV_Error(Error::StsUnsupportedFormat,
                 cv::format("Failed to parse ONNX model: %s", onnxFile));
    }
...
ONNXImporter::ONNXImporter(Net& net, const char* buffer, size_t sizeBuffer)
    : missingLayerHandler(DNN_DIAGNOSTICS_RUN ? new detail::LayerHandler()
      ...
      onnx_opset(0) {
    hasDynamicShapes = false;
    CV_LOG_DEBUG(NULL, "DNN/ONNX: processing in-memory ONNX model ("
                           << sizeBuffer << " bytes)");
...
inline void replaceLayerParam(LayerParams& layerParams, const String& oldKey,
                              const String& newKey) {
...
static void dumpValueInfoProto(
    int i, const opencv_onnx::ValueInfoProto& valueInfoProto,
    ...
    for (int j = 0; j < dim_size; ++j) {
        const opencv_onnx::TensorShapeProto_Dimension& dimension =
            tensorShape.dim(j);
        if (dimension.has_dim_param()) {
            CV_LOG_DEBUG(NULL, "DNN/ONNX: " << prefix << "[" << i << "] dim["
                                            << j << "] = <"
                                            << dimension.dim_param()
                                            << "> (dynamic)");
        }
        ...
        if (dimension.has_denotation()) {
            CV_LOG_INFO(NULL, "DNN/ONNX: " << prefix << "[" << i << "] dim["
                                           << j << "] denotation is '"
                                           << dimension.denotation() << "'");
        }
        shape[j] = dimension.dim_value();
    }
    CV_LOG_DEBUG(NULL, "DNN/ONNX: " << prefix << "[" << i << " as '"
                                    << valueInfoProto.name()
                                    << "'] shape=" << toString(shape));
}

static void dumpTensorProto(int i, const opencv_onnx::TensorProto& tensorProto,
                            const std::string& prefix) {
    ...
    CV_LOG_VERBOSE(
        NULL, 0,
        "DNN/ONNX: " << prefix << "[" << i << " as '" << tensorProto.name()
                     << "'] shape=" << toString(shape)
                     << " data_type=" << (int)tensorProto.data_type());
}
...
std::map<std::string, Mat> ONNXImporter::getGraphTensors(
    ...
    for (int i = 0; i < graph_proto.initializer_size(); i++) {
        const opencv_onnx::TensorProto& tensor_proto =
            graph_proto.initializer(i);
        dumpTensorProto(i, tensor_proto, "initializer");
        Mat mat = getMatFromTensor(tensor_proto);
        releaseONNXTensor(const_cast<opencv_onnx::TensorProto&>(
            tensor_proto));  // drop already loaded data

        if (DNN_DIAGNOSTICS_RUN && mat.empty()) continue;
    ...
    for (int i = 0; i < node_proto.attribute_size(); i++) {
        ...
        try {
            if (attribute_name == "kernel_shape") {
                CV_Assert(attribute_proto.ints_size() == 1 ||
                          attribute_proto.ints_size() == 2 ||
                          attribute_proto.ints_size() == 3);
                ...
                if (node_proto.op_type() == "Pad") {
                    // Padding layer.
                    // Paddings are in order begin0, begin1, .. beginN, end0,
                    // end1, ..., endN. We need to shuffle it to begin0, end0,
                    // begin1, end1, ...
                    ...
                    lp.set("paddings",
                           DictValue::arrayInt(&paddings[0], paddings.size()));
                } else {
                    // Convolution or pooling.
                    CV_Assert(attribute_proto.ints_size() == 2 ||
                              attribute_proto.ints_size() == 4 ||
                              attribute_proto.ints_size() == 6);
                    lp.set("pad", parse(attribute_proto.ints()));
                }
            } else if (attribute_name == "auto_pad") {
                if (attribute_proto.s() == "SAME_UPPER" ||
                    attribute_proto.s() == "SAME_LOWER") {
                ...
                lp.set(attribute_name,
                       DictValue::arrayReal(attribute_proto.floats().data(),
                                            attribute_proto.floats_size()));
                ...
                CV_Error(Error::StsNotImplemented,
                         cv::format(
                             "DNN/ONNX/Attribute[%s]: 'Graph' is not supported",
                             attribute_name.c_str()));
            } else if (attribute_proto.graphs_size() > 0) {
                CV_Error(Error::StsNotImplemented,
                         cv::format("DNN/ONNX/Attribute[%s]: 'Graphs' (%d) in "
                                    "attributes is not supported",
                                    attribute_name.c_str(),
                                    attribute_proto.graphs_size()));
            } else if (attribute_proto.strings_size() > 0) {
                std::string msg = cv::format(
                    "DNN/ONNX/Attribute[%s]: 'Strings' (%d) are not supported",
                    attribute_name.c_str(), attribute_proto.strings_size());
                CV_LOG_ERROR(NULL, msg);
                for (int i = 0; i < attribute_proto.strings_size(); i++) {
                    CV_LOG_ERROR(NULL, "    Attribute["
                                           << attribute_name << "].string(" << i
                                           << ") = '"
                                           << attribute_proto.strings(i)
                                           << "'");
                }
                CV_Error(Error::StsNotImplemented, msg);
            } else if (attribute_proto.tensors_size() > 0) {
                CV_Error(Error::StsNotImplemented,
                         cv::format("DNN/ONNX/Attribute[%s]: 'Tensors' (%d) in "
                                    "attributes are not supported",
                                    attribute_name.c_str(),
                                    attribute_proto.tensors_size()));
            } else {
                CV_Error(
                    Error::StsNotImplemented,
                    cv::format(
                        "DNN/ONNX/Attribute[%s]: unsupported attribute format",
                        attribute_name.c_str()));
            }
            ...
            if (DNN_DIAGNOSTICS_RUN) {
                CV_LOG_ERROR(NULL,
                             "DNN/ONNX: Potential problem with processing "
                             "attributes for node "
                                 << node_proto.name() << " Attribute "
                                 << attribute_name.c_str());
                continue;
            }
            throw;
...
Mat ONNXImporter::getBlob(const std::string& input_name) {
    std::map<std::string, Mat>::const_iterator constBlob =
        constBlobs.find(input_name);
    if (constBlob == constBlobs.end()) {
        CV_Error(Error::StsBadArg, std::string("Blob ") + input_name +
                                       " not found in const blobs");
    }
...
void ONNXImporter::addLayer(LayerParams& layerParams,
    ...
    int id =
        dstNet.addLayer(layerParams.name, layerParams.type, depth, layerParams);
    ...
    for (int j = 0; j < node_proto.input_size(); j++) {
        ...
        if (layerId != layer_id.end()) {
            dstNet.connect(layerId->second.layerId, layerId->second.outputId,
                           id, inpNum);
            ++inpNum;
    ...
    Ptr<Layer> layer = dstNet.getLayer(
        id);  // FIXIT: avoid instantiation of layers during the import stage
    layer->getMemoryShapes(layerInpShapes, 0, layerOutShapes,
                           layerInternalShapes);
    for (int i = 0;
         i < node_proto.output_size() && i < (int)layerOutShapes.size(); ++i) {
 ...
 */
void ONNXImporter::expandMid(const std::string& prefix,
    ...
    for (size_t j = 0; j < n; j++) {
        ...
        CV_Assert((layer_id.find(copyLP.name) == layer_id.end()) &&
                  "Couldn't copy the node: generated name already exists in "
                  "the graph.");
 ...
 */
void ONNXImporter::addNegation(const LayerParams& layerParams,
                               opencv_onnx::NodeProto& node_proto,
                               int input_id) {
...
void ONNXImporter::addConstant(const std::string& name, const Mat& blob) {
    CV_LOG_DEBUG(NULL, "DNN/ONNX: add constant '"
                           << name << "' shape=" << toString(shape(blob))
                           << ": " << toString(blob));
...
void ONNXImporter::parseOperatorSet() {
    int ir_version = model_proto.has_ir_version()
                         ? static_cast<int>(model_proto.ir_version())
                         : -1;
    if (ir_version < 3) return;
    ...
    for (int i = 0; i < opset_size; ++i) {
        const ::opencv_onnx::OperatorSetIdProto& opset_entry =
            model_proto.opset_import(i);
        const std::string& domain =
            opset_entry.has_domain() ? opset_entry.domain() : std::string();
        int version = opset_entry.has_version() ? opset_entry.version() : -1;
        if (domain.empty() || domain == str_domain_ai_onnx) {
            // ONNX opset covered by specification:
            // https://github.com/onnx/onnx/blob/master/docs/Operators.md
            onnx_opset = std::max(onnx_opset, version);
            onnx_opset_map[str_domain_ai_onnx] = onnx_opset;
        } else {
            CV_LOG_DEBUG(NULL, "DNN/ONNX: using non-standard ONNX opset["
                                   << i << "]: domain='" << domain
                                   << "' version=" << version);
    ...
    for (const auto& pair : onnx_opset_map) {
        if (pair.first == str_domain_ai_onnx) {
            ...
            CV_LOG_INFO(NULL, "DNN/ONNX: unknown domain='"
                                  << pair.first << "' version=" << pair.second
                                  << ". No dispatch map, you may need to "
                                     "register 'custom' layers.");
        }
    }
}

void ONNXImporter::handleQuantizedNode(
    LayerParams& layerParams, const opencv_onnx::NodeProto& node_proto) {
    ...
    if (outName.substr(len - 9) == "quantized") {
        ...
        if (scale.total() != 1 || zeropoint.total() != 1)
            CV_Error(Error::StsNotImplemented,
                     "Per-channel scales/zeropoints are not supported");

        layerParams.set("depth", CV_8S);
        layerParams.set("scales", DictValue::arrayReal(scale.ptr<float>(), 1));
        layerParams.set("zeropoints",
                        DictValue::arrayInt(zeropoint.ptr<int8_t>(), 1));
    }
}
...
void ONNXImporter::populateNet() {
    ...
    CV_LOG_INFO(NULL,
                "DNN/ONNX: loading ONNX"
                    << (model_proto.has_ir_version()
                            ? cv::format(" v%d", (int)model_proto.ir_version())
                            : cv::String())
                    << " model produced by '" << framework_name << "'"
                    << (framework_version.empty()
                            ? cv::String()
                            : cv::format(":%s", framework_version.c_str()))
    ...
    CV_LOG_DEBUG(NULL,
                 "DNN/ONNX: graph simplified to " << layersSize << " nodes");

    constBlobs = getGraphTensors(graph_proto);  // scan GraphProto.initializer
    std::vector<String>
        netInputs;  // map with network inputs (without const blobs)
    // Add all the inputs shapes. It includes as constant blobs as network's
    // inputs shapes.
    for (int i = 0; i < graph_proto.input_size(); ++i) {
        const opencv_onnx::ValueInfoProto& valueInfoProto =
            graph_proto.input(i);
        CV_Assert(valueInfoProto.has_name());
        ...
        int dim_size = tensorShape.dim_size();
        CV_CheckGE(dim_size, 0,
                   "");  // some inputs are scalars (dims=0), e.g. in
                         // Test_ONNX_nets.Resnet34_kinetics test
        MatShape inpShape(dim_size);
        for (int j = 0; j < dim_size; ++j) {
            const opencv_onnx::TensorShapeProto_Dimension& dimension =
                tensorShape.dim(j);
            if (dimension.has_dim_param()) {
                CV_LOG_DEBUG(NULL, "DNN/ONNX: input[" << i << "] dim[" << j
                                                      << "] = <"
                                                      << dimension.dim_param()
                                                      << "> (dynamic)");
            }
            // https://github.com/onnx/onnx/blob/master/docs/DimensionDenotation.md#denotation-definition
            if (dimension.has_denotation()) {
                CV_LOG_INFO(NULL, "DNN/ONNX: input[" << i << "] dim[" << j
                                                     << "] denotation is '"
                                                     << dimension.denotation()
                                                     << "'");
            }
            inpShape[j] = dimension.dim_value();
            // NHW, NCHW(NHWC), NCDHW(NDHWC); do not set this flag if only N is
            // dynamic
            if (dimension.has_dim_param() &&
                !(j == 0 && inpShape.size() >= 3)) {
        ...
        CV_LOG_IF_DEBUG(NULL, !isInitialized,
                        "DNN/ONNX: input["
                            << i << " as '" << name
                            << "'] shape=" << toString(inpShape));
        CV_LOG_IF_VERBOSE(NULL, 0, isInitialized,
                          "DNN/ONNX: pre-initialized input["
                              << i << " as '" << name
                              << "'] shape=" << toString(inpShape));
        if (dim_size > 0 &&
            !hasDynamicShapes)  // FIXIT result is not reliable for models with
                                // multiple inputs
        {
            inpShape[0] = std::max(
                inpShape[0], 1);  // It's OK to have undetermined batch size
        }
        ...
        if (!isInitialized) {
            ...
            layer_id.insert(
                std::make_pair(name, LayerInfo(0, netInputs.size() - 1)));
        }
    }
    ...
    CV_LOG_DEBUG(NULL,
                 (DNN_DIAGNOSTICS_RUN ? "DNN/ONNX: diagnostic run completed!"
                                      : "DNN/ONNX: import completed!"));
}
...
void ONNXImporter::handleNode(const opencv_onnx::NodeProto& node_proto) {
    ...
    const std::string& layer_type_domain = [&]() {
        if (!node_proto.has_domain()) return str_domain_ai_onnx;
        const std::string& domain = node_proto.domain();
        if (domain.empty()) return str_domain_ai_onnx;
        return domain;
    }();
    const auto& dispatch = [&]() {
        if (layer_type_domain != str_domain_ai_onnx) {
            if (onnx_opset_map.find(layer_type_domain) ==
                onnx_opset_map.end()) {
                CV_LOG_WARNING(
                    NULL, "DNN/ONNX: processing node with "
                              << node_proto.input_size() << " inputs and "
                              << node_proto.output_size() << " outputs: "
                              << cv::format("[%s]:(%s)", layer_type.c_str(),
                                            name.c_str())
                              << " from undeclared domain='"
                              << layer_type_domain << "'");
            } else {
                CV_LOG_DEBUG(
                    NULL, "DNN/ONNX: processing node with "
            ...
            if (it == domain_dispatch_map.end()) {
                CV_LOG_WARNING(NULL,
                               "DNN/ONNX: missing dispatch map for domain='"
                                   << layer_type_domain << "'");
                return DispatchMap();
            }
            return it->second;
    ...
    try {
        // FIXIT not all cases can be repacked into "LayerParams". Importer
        // should handle such cases directly for each "layer_type"
        ...
        if (DNN_DIAGNOSTICS_RUN) {
            CV_LOG_ERROR(
                NULL,
                "DNN/ONNX: Potential problem during processing node with "
                    << node_proto.input_size() << " inputs and "
                    << node_proto.output_size() << " outputs: "
            ...
            if (registeredLayers.find(layerParams.type) !=
                registeredLayers.end()) {
                try {
                    Ptr<Layer> layer = LayerFactory::createLayerInstance(
                        layerParams.type, layerParams);
                } catch (const std::exception& e) {
                    CV_LOG_ERROR(NULL,
                                 "DNN/ONNX: Layer of type "
                                     << layerParams.type << "(" << layer_type
                                     << ") cannot be created with parameters "
                                     << layerParams << ". Error: " << e.what());
                }
            }
        } else {
            CV_LOG_ERROR(
                NULL,
                "DNN/ONNX: ERROR during processing node with "
                    << node_proto.input_size() << " inputs and "
                    << node_proto.output_size() << " outputs: "
                    << cv::format("[%s]:(%s)", layer_type.c_str(), name.c_str())
                    << " from domain='" << layer_type_domain << "'");
        ...
        for (int i = 0; i < node_proto.input_size(); i++) {
            CV_LOG_INFO(NULL, "    Input[" << i << "] = '"
                                           << node_proto.input(i) << "'");
        }
        for (int i = 0; i < node_proto.output_size(); i++) {
            CV_LOG_INFO(NULL, "    Output[" << i << "] = '"
                                            << node_proto.output(i) << "'");
        }
        if (DNN_DIAGNOSTICS_RUN) {
            for (int i = 0; i < node_proto.output_size(); ++i) {
                layer_id.insert(
                    std::make_pair(node_proto.output(i), LayerInfo(0, i)));
                outShapes[node_proto.output(i)] =
                    outShapes[node_proto.input(0)];
            }
        } else
            CV_Error(Error::StsError,
                     cv::format("Node [%s@%s]:(%s) parse error: %s",
                                layer_type.c_str(), layer_type_domain.c_str(),
                                name.c_str(), e.what()));
    }
}

void ONNXImporter::parseArg(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    const std::string& layer_type = node_proto.op_type();
...
void ONNXImporter::parseMaxUnpool(LayerParams& layerParams,
                                  const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseMaxPool(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto) {
    int depth = layerParams.get<int>("depth", CV_32F);
...
void ONNXImporter::parseAveragePool(LayerParams& layerParams,
                                    const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseReduce(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto_) {
    ...
    if (pool == "AVE") {
        ...
        int num_dims = inpShape.size();
        layerParams.set("num_dims", num_dims);
    }
    ...
    if (layerParams.has("axes") &&
        ...
        if (inpShape.size() == 3 && axes.size() <= 2) {
            ...
            avgLp.set("pool", pool);
            if (axes.size() == 2) {
                CV_CheckEQ(normalize_axis(axes.get<int>(0), inpShape.size()), 1,
                           "Unsupported mode");
                CV_CheckEQ(normalize_axis(axes.get<int>(1), inpShape.size()), 2,
                           "Unsupported mode");
                avgLp.set("global_pooling", true);
            } else {
                avgLp.set(axis == 2 ? "global_pooling_w" : "global_pooling_h",
                          true);
            ...
            if (inpShape.size() != 4 && inpShape.size() != 5)
                CV_Error(
                    Error::StsNotImplemented,
                    "Unsupported input shape of " + layer_type + " operation.");

            CV_Assert(axes.size() <= inpShape.size() - 2);
            std::vector<int> kernel_size(inpShape.size() - 2, 1);
            if (axes.size() == 1 &&
                (normalize_axis(axes.get<int>(0), inpShape.size()) <= 1)) {
                int axis = normalize_axis(axes.get<int>(0), inpShape.size());
                ...
                CV_Assert(layer_id.find(reshapeLp.name) == layer_id.end());
                reshapeLp.set(
                    "dim", DictValue::arrayInt(&newShape[0], newShape.size()));
                ...
                for (int i = 0; i < axes.size(); i++) {
                    int axis =
                        normalize_axis(axes.get<int>(i), inpShape.size());
            ...
            poolLp.set("kernel_size", DictValue::arrayInt(&kernel_size[0],
                                                          kernel_size.size()));
        ...
        layerParams.set(
            "dim", DictValue::arrayInt(&targetShape[0], targetShape.size()));

        node_proto.set_input(0, node_proto.output(0));
        node_proto.set_output(0, layerParams.name);
    } else if (!layerParams.has("axes") &&
               (layer_type == "ReduceMean" || layer_type == "ReduceSum" ||
                layer_type == "ReduceMax")) {
        ...
        layerParams.set(
            "dim", DictValue::arrayInt(targetShape.data(), targetShape.size()));
...
void ONNXImporter::parseSlice(LayerParams& layerParams,
                              const opencv_onnx::NodeProto& node_proto) {
    int axis = 0;
    ...
    if (inp_size == 1) {
        ...
        for (int i = 0; i < starts.size(); ++i) {
            ...
            end.push_back((finish < 0)
                              ? --finish
                              : finish);  // numpy doesn't include last dim
        }
    } else {  // inp_size > 1
        ...
        std::copy(starts, starts + start_blob.total(),
                  std::back_inserter(begin));
        ...
        if (inp_size == 5) {
            ...
            if (axis > 0) steps.resize(axis, 1);

            std::copy(steps_ptr, steps_ptr + step_blob.total(),
            ...
            if (constBlobs.find(node_proto.input(0)) != constBlobs.end() &&
                axis == 0 && start_blob.at<int>(0) == -1 &&
                step_blob.at<int>(0) == -1 &&
...
void ONNXImporter::parseSplit(LayerParams& layerParams,
                              const opencv_onnx::NodeProto& node_proto) {
    if (layerParams.has("split")) {
        ...
        layerParams.set("slice_point", DictValue::arrayInt(&slicePoints[0],
                                                           slicePoints.size()));
    } else {
...
void ONNXImporter::parseBias(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    const std::string& layer_type = node_proto.op_type();
    ...
    CV_Assert((node_proto.input_size() == 2) ||
              (layer_type == "Sum" && node_proto.input_size() > 2));

    if (layer_type == "Sum" && node_proto.input_size() > 2) {
        for (int i = 0; i < node_proto.input_size(); ++i) {
            if (layer_id.find(node_proto.input(i)) == layer_id.end()) {
                CV_Error(Error::StsNotImplemented,
                         "Sum of constants is not implemented for inputs > 2");
            }
        }
    }
    ...
    if (is_const_0 && is_const_1) {
        ...
        if (blob_total == 1) {
            ...
            if (shape(blob) == inpShape) {
                ...
                int id = dstNet.addLayer(constParams.name, constParams.type,
                                         constParams);
                layer_id.insert(
                    std::make_pair(constParams.name, LayerInfo(id, 0)));
                outShapes[constParams.name] = shape(blob);

                layerParams.type = "Eltwise";
                float coeffs[] = {1., isSub ? -1.f : 1.f};
                layerParams.set("coeff",
                                DictValue::arrayReal<float*>(coeffs, 2));
                ...
                for (int i = 0; i < graph_proto.initializer_size(); i++) {
                    opencv_onnx::TensorProto tensor_proto =
                        graph_proto.initializer(i);
                    if (tensor_proto.name() ==
                        node_proto.input(const_blob_id)) {
    ...
    } else if (outShapes[node_proto.input(0)] ==
               outShapes[node_proto.input(1)]) {
        layerParams.type = "Eltwise";
        if (isSub) {
            static float subCoeffs[] = {1.f, -1.f};
            layerParams.set("coeff",
                            DictValue::arrayReal<float*>(subCoeffs, 2));
        }
    } else {
        if (isSub) {
...
void ONNXImporter::parsePow(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    if (layer_id.find(node_proto.input(1)) != layer_id.end())
        CV_Error(Error::StsNotImplemented,
                 "Unsupported Pow op with variable power");
...
// "Min" "Max"
void ONNXImporter::parseMinMax(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto) {
    const std::string& layer_type = node_proto.op_type();
    layerParams.type = "Eltwise";
...
void ONNXImporter::parseNeg(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    layerParams.type = "Power";
...
void ONNXImporter::parseConstant(LayerParams& layerParams,
                                 const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseLSTM(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    ...
    const int numDirs =
        Wx.size[0];  // Is 1 for forward only and 2 for bidirectional LSTM.
    ...
    if (!node_proto.input(5).empty()) {
        ...
        // initial_h attribute can be empty in case of keras2onnx producer. fill
        // it with zeros
    ...
    if (!node_proto.input(6).empty()) {
        ...
        // initial_c attribute can be empty in case of keras2onnx producer. fill
        // it with zeros
    ...
    lstmParams.set("reverse",
                   lstmParams.get<String>("direction", "") == "reverse");
    lstmParams.set("bidirectional",
                   lstmParams.get<String>("direction", "") == "bidirectional");

    node_proto.set_output(
        0, lstmParams.name);  // set different name so output shapes will be
                              // registered on that name
    ...
    layerParams.type = "Reshape";
    layerParams.set("dim",
                    DictValue::arrayInt(&lstmShape[0], lstmShape.size()));
...
void ONNXImporter::parseGRU(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    ...
    gruParams.set("bidirectional",
                  gruParams.get<String>("direction", "") == "bidirectional");

    node_proto.set_output(
        0, gruParams.name);  // set different name so output shapes will be
                             // registered on that name
...
void ONNXImporter::parseImageScaler(LayerParams& layerParams,
                                    const opencv_onnx::NodeProto& node_proto) {
    const float scale =
        layerParams.has("scale") ? layerParams.get<float>("scale") : 1.0f;
...
void ONNXImporter::parseClip(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseLeakyRelu(LayerParams& layerParams,
                                  const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseRelu(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto) {
    layerParams.type = "ReLU";
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseElu(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    layerParams.type = "ELU";
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseTanh(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto) {
    layerParams.type = "TanH";
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseAbs(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    layerParams.type = "AbsVal";
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseCompare(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() == 2);
    const std::string& layer_type = node_proto.op_type();
...
void ONNXImporter::parsePRelu(LayerParams& layerParams,
                              const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseLRN(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    replaceLayerParam(layerParams, "size", "local_size");
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseInstanceNormalization(
    LayerParams& layerParams, const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    if (node_proto.input_size() != 3)
        CV_Error(Error::StsNotImplemented, "Expected input, scale, bias");
...
void ONNXImporter::parseBatchNormalization(
    LayerParams& layerParams, const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseGemm(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() >= 2);
...
void ONNXImporter::parseMatMul(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() == 2);
    layerParams.type = "InnerProduct";
...
void findBroadAxis(const MatShape& broadShape, const MatShape& outShape,
                   size_t& axis, int& broadAxis) {
    ...
    // dimensions from the left of axis and from the right of endAxis will be
    // handled by Scale layer
    broadAxis = -1;
...
// "Mul" "Div"
void ONNXImporter::parseMul(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    const std::string& layer_type = node_proto.op_type();
    CV_Assert(node_proto.input_size() == 2);
    ...
    if (constId != -1 && haveVariables) {
        ...
        if (blob.total() == 1) {
            ...
            if (isDiv) {
                ...
                if (constId == 0) {
                    // Power layer calculates (x*scale + shift)^power, so
                    // const/x -> (x * (1/const) + 0)^(-1)
        ...
        if (inp0.size != inp1.size && (inp0.total() != 1 || inp1.total() != 1))
            CV_Error_(Error::StsNotImplemented,
                      ("Different shapes case is not supported with constant "
                       "inputs: %s",
                       layer_type.c_str()));
        ...
        if (total(outShapes[node_proto.input(0)]) <
            total(outShapes[node_proto.input(1)])) {
            opencv_onnx::NodeProto proto;
        ...
        if (isDiv) {
            ...
            // Create Power layer
            int id = dstNet.addLayer(powerParams.name, powerParams.type,
                                     powerParams);
            // Connect to input
        ...
        // if there is a one dimension in the middle that should be broadcasted,
        // broadcast it
        if (broadAxis != -1) {
            opencv_onnx::NodeProto concat_node_proto = node_proto;
            const std::string& input1 = concat_node_proto.input(1);

            expandMid(layerParams.name, concat_node_proto, input1,
                      outShape[broadAxis]);
...
void ONNXImporter::parseConv(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    CV_Assert(node_proto.input_size() >= 2);
    ...
    int outCn = layerParams.blobs.empty() ? outShapes[node_proto.input(1)][0]
                                          : layerParams.blobs[0].size[0];
    ...
    if (layerParams.has("pad")) {
        ...
        if (asymmetricPadding &&
            pads.size() == 4)  // [pad_t, pad_l, pad_b, pad_r]
        {
...
void ONNXImporter::parseConvTranspose(
    LayerParams& layerParams, const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() >= 2);
    ...
    if (layerParams.has("output_shape")) {
        ...
        if (layerParams.has("pad_mode")) {
            ...
            if (padMode != "SAME" && padMode != "VALID")
                CV_Error(Error::StsError,
                         "Unsupported padding mode " + padMode);

            for (int i = 0; i < strides.size(); i++) {
                int sz = outShape.get<int>(2 + i);
                int stride = strides.get<int>(i);
                adjust_pads.push_back(padMode == "SAME"
                                          ? (sz - 1) % stride
                                          : (sz - kernel.get<int>(i)) % stride);
            }
            layerParams.set("adj", DictValue::arrayInt(&adjust_pads[0],
                                                       adjust_pads.size()));
        }
...
void ONNXImporter::parseTranspose(LayerParams& layerParams,
                                  const opencv_onnx::NodeProto& node_proto) {
    int depth = layerParams.get<int>("depth", CV_32F);
...
void ONNXImporter::parseSqueeze(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto) {
    ...
    for (int i = 0; i < inpShape.size(); ++i) {
        if (!maskedAxes[i]) outShape.push_back(inpShape[i]);
    }
    if (outShape.size() != inpShape.size()) {
        layerParams.type = "Reshape";
        layerParams.set("dim",
                        DictValue::arrayInt(&outShape[0], outShape.size()));
        if (hasDynamicShapes) {
            std::vector<int> dynamicAxes;
            std::vector<int> inputIndices;
            for (int index = 0; index < inpShape.size(); ++index) {
                if (!maskedAxes[index]) inputIndices.push_back(index);
            }
            for (int index = 0; index < outShape.size(); ++index)
                dynamicAxes.push_back(index);
            layerParams.set(
                "dynamic_axes",
                DictValue::arrayInt(dynamicAxes.data(), dynamicAxes.size()));
            layerParams.set(
                "input_indices",
                DictValue::arrayInt(inputIndices.data(), inputIndices.size()));
        }
    } else
        layerParams.type = "Identity";
...
void ONNXImporter::parseFlatten(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    CV_CheckEQ(node_proto.input_size(), 1, "");
    ...
    if (axis == 0 || axis == inpShape.size()) {
        ...
        reshapeLp.set("dim",
                      DictValue::arrayInt(&inpShape[0], inpShape.size()));
...
void ONNXImporter::parseUnsqueeze(LayerParams& layerParams,
                                  const opencv_onnx::NodeProto& node_proto) {
    ...
    if (hasDynamicShapes) {
        ...
        std::vector<int> inputIndices;
        for (int index = 0; index < outShape.size(); ++index) {
            if (index != axis) dynamicAxes.push_back(index);
        }
        for (int index = 0; index < inpShape.size(); ++index)
...
void ONNXImporter::parseExpand(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    ...
    MatShape targetShape(newShapeMat.ptr<int>(),
                         newShapeMat.ptr<int>() + newShapeMat.total());
    ...
    if (targetShape.size() == inpShape.size() + 1) {
        inpShape.insert(inpShape.begin(), targetShape.size() - inpShape.size(),
                        1);
        for (int i = 0; i < targetShape.size(); i++) {
            if (abs(targetShape[i]) == 1) targetShape[i] = inpShape[i];
        }
        if (haveVariables) {
            LayerParams reshapeLp;
            reshapeLp.name = layerParams.name + "/reshape";
    ...
    CV_CheckEQ(inpShape.size(), targetShape.size(),
               "Unsupported Expand op with different dims");

    std::vector<int> broadcast_axes;
    // shapes aren't right-aligned here because targetShape.size() ==
    // inpShape.size()
    for (int i = 0; i < targetShape.size(); i++) {
        if (targetShape[i] != inpShape[i]) {
            if (inpShape[i] == 1) {
                ...
                CV_Error(Error::StsError,
                         format("Could not be broadcast by axis: %d", i));
            }
        }
    }
    ...
    if (!haveVariables) {
        if (broadcast_axes.size() != 1)
            CV_Error(
                Error::StsNotImplemented,
                "Expand op doesn't support multiple axes for constant input");
    ...
    if (broadcast_axes.size() == 2 &&
        broadcast_axes[0] == broadcast_axes[1] - 1 &&
        broadcast_axes[1] == inpShape.size() - 1) {
        LayerParams constParams;
        constParams.name = layerParams.name + "/const";
        ...
        Mat inp =
            Mat::ones(newShapeMat.total(), newShapeMat.ptr<int>(), CV_32F);
        ...
        expandMid(layerParams.name, node_proto, srcName,
                  targetShape[broadcast_axes[0]]);
...
void ONNXImporter::parseReshape(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto) {
    ...
    if (node_proto.input_size() == 2) {
        ...
        layerParams.set(
            "dim", DictValue::arrayInt<int*>(blob.ptr<int>(), blob.total()));
...
void ONNXImporter::parsePad(LayerParams& layerParams,
                            const opencv_onnx::NodeProto& node_proto) {
    int depth = layerParams.get<int>("depth", CV_32F);
    ...
    if (node_proto.input_size() == 3 || node_proto.input_size() == 2) {
        // Paddings are in order begin0, begin1, .. beginN, end0, end1, ...,
        // endN. We need to shuffle it to begin0, end0, begin1, end1, ...
        Mat paddings = getBlob(node_proto, 1).reshape(1, 2);
        paddings = paddings.t();
        layerParams.set("paddings", DictValue::arrayInt(paddings.ptr<int>(),
                                                        paddings.total()));

        if (node_proto.input_size() == 3) {
            Mat value = getBlob(node_proto, 2);
            float padValue = (depth == CV_8S) ? (float)value.ptr<int8_t>()[0]
                                              : value.ptr<float>()[0];
...
void ONNXImporter::parseShape(LayerParams& layerParams,
                              const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() == 1);
    IterShape_t shapeIt = outShapes.find(node_proto.input(0));
    CV_Assert(shapeIt != outShapes.end());
    ...
    if (isDynamicShape) {
        CV_LOG_ERROR(
            NULL,
            "DNN/ONNX(Shape): dynamic 'zero' shapes are not supported, input "
                << toString(inpShape, node_proto.input(0)));
...
void ONNXImporter::parseCast(LayerParams& layerParams,
                             const opencv_onnx::NodeProto& node_proto) {
    if (constBlobs.find(node_proto.input(0)) != constBlobs.end()) {
...
void ONNXImporter::parseConstantFill(LayerParams& layerParams,
                                     const opencv_onnx::NodeProto& node_proto) {
    int depth = CV_32F;
    float fill_value;
    ...
    for (int i = 0; i < inpShape.size(); i++) CV_CheckGT(inpShape[i], 0, "");
    Mat tensor(inpShape.size(), &inpShape[0], depth, Scalar(fill_value));
    addConstant(layerParams.name, tensor);
}

void ONNXImporter::parseGather(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    CV_Assert(node_proto.input_size() == 2);
    ...
    if ((constBlobs.find(node_proto.input(0)) != constBlobs.end())) {
        ...
        LayerParams sliceLp;
        sliceLp.type = "Slice";
        sliceLp.name = inpShape.size() > 1 ? layerParams.name + "/slice"
                                           : layerParams.name;
        ...
        cv::dnn::DictValue paramBegin =
            cv::dnn::DictValue::arrayInt(begin.data(), begin.size());
        cv::dnn::DictValue paramEnd =
            cv::dnn::DictValue::arrayInt(end.data(), end.size());
        ...
        if (inpShape.size() > 1) {
            ...
            if (hasDynamicShapes) {
                ...
                for (int index = 0; index < inpShape.size(); ++index)
                    inputIndices.push_back(index);
                layerParams.set("dynamic_axes",
                                DictValue::arrayInt(dynamicAxes.data(),
                                                    dynamicAxes.size()));
                layerParams.set("input_indices",
                                DictValue::arrayInt(inputIndices.data(),
                                                    inputIndices.size()));
            }
...
void ONNXImporter::parseConcat(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto) {
    ...
    if (!hasVariableInps) {
        ...
        // Due constant folding we can get inputs with different number of
        // dimensions Insert the missing dimension to inputs
        MatShape inputShape;
        for (size_t i = 0; i < inputs.size(); ++i) {
        ...
        // Concat-1 has default value for axis is 1:
...
void ONNXImporter::parseResize(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto) {
    ...
    if (layerParams.has("coordinate_transformation_mode")) {
        String interp_mode =
            layerParams.get<String>("coordinate_transformation_mode");
    ...
    } else if (node_proto.input_size() >= 4)  // opset-11
    {
        ...
        if (constBlobs.find(inputSizes) != constBlobs.end()) {
            ...
            CV_CheckDepth(shapes.depth(),
                          shapes.depth() == CV_32S || shapes.depth() == CV_32F,
                          "");
            if (shapes.depth() == CV_32F) shapes.convertTo(shapes, CV_32S);
            layerParams.set("width", shapes.at<int>(3));
            layerParams.set("height", shapes.at<int>(2));
        } else {
            CV_Error(Error::StsNotImplemented,
                     cv::format("ONNX/Resize: doesn't support dynamic "
                                "non-constant 'sizes' input: %s",
                                inputSizes.c_str()));
        }
    } else {
        CV_Error(Error::StsNotImplemented,
                 "ONNX/Resize: can't find neither 'scale' nor destination "
                 "sizes parameters");
    }
...
void ONNXImporter::parseUpsample(LayerParams& layerParams,
                                 const opencv_onnx::NodeProto& node_proto) {
    ...
    } else if (layerParams.has("height_scale") &&
               layerParams.has("width_scale")) {
        // Caffe2 layer
...
void ONNXImporter::parseSoftMax(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto) {
    const std::string& layer_type = node_proto.op_type();
...
void ONNXImporter::parseDetectionOutput(
    LayerParams& layerParams, const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
...
void ONNXImporter::parseCumSum(LayerParams& layerParams,
                               const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseCustomLayer(LayerParams& layerParams,
                                    const opencv_onnx::NodeProto& node_proto) {
    const std::string& name = layerParams.name;
    std::string& layer_type = layerParams.type;
    const std::string& layer_type_domain =
        node_proto.has_domain() ? node_proto.domain() : std::string();
    if (!layer_type_domain.empty() && layer_type_domain != str_domain_ai_onnx) {
        ...
        static bool DNN_CUSTOM_ONNX_TYPE_INCLUDE_DOMAIN_NAME =
            utils::getConfigurationParameterBool(
                "OPENCV_DNN_CUSTOM_ONNX_TYPE_INCLUDE_DOMAIN_NAME", true);
    ...
    CV_LOG_INFO(
        NULL,
        "DNN/ONNX: unknown node type, try using custom handler for node with "
            << node_proto.input_size() << " inputs and "
            << node_proto.output_size() << " outputs: "
            << cv::format("[%s]:(%s)", layer_type.c_str(), name.c_str()));
...
void ONNXImporter::parseQuantDequant(LayerParams& layerParams,
                                     const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() == 3);
    layerParams.type =
        (node_proto.op_type() == "QuantizeLinear") ? "Quantize" : "Dequantize";
...
void ONNXImporter::parseQConv(LayerParams& layerParams,
                              const opencv_onnx::NodeProto& node_proto) {
    ...
    Mat wt_sc = (w_scale.total() == outCn)
                    ? w_scale
                    : Mat(1, outCn, CV_32F, Scalar(w_scale.at<float>(0)));

    Mat out_sc = getBlob(node_proto, 6);
    Mat bias =
        (ninputs == 9) ? getBlob(node_proto, 8) : Mat::zeros(1, outCn, CV_32S);
    ...
    for (int i = 0; i < outCn; i++) {
        biasFused.at<int>(i) =
            bias.at<int>(i) -
            inp_zp.at<int8_t>(0) * (cv::sum(weights_2d.row(i))[0]);
        outputMultiplier.at<float>(i) =
            (inp_sc.at<float>(0) * wt_sc.at<float>(i)) / out_sc.at<float>(0);
    }
...
void ONNXImporter::parseQMatMul(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto) {
    int ninputs = node_proto.input_size();
    CV_Assert(ninputs == 8);
...
void ONNXImporter::parseQEltwise(LayerParams& layerParams,
                                 const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
    ...
    std::vector<float> inp_scales = {inp_0_sc.at<float>(0),
                                     inp_1_sc.at<float>(0)};
    std::vector<int8_t> inp_zps = {inp_0_zp.at<int8_t>(0),
                                   inp_1_zp.at<int8_t>(0)};
    ...
    if (constId != -1) {
        ...
        if (blob.total() == 1) {
            ...
            if (op == "prod") scale *= val;

            float shift = out_zp - scale * inp_zps[0];
            if (op == "sum") shift += (val / out_sc);
            ...
            if (shape(blob) == inpShape) {
                ...
                constParams.set("scales",
                                DictValue::arrayReal(inp_1_sc.ptr<float>(), 1));
                constParams.set("zeropoints",
                                DictValue::arrayInt(inp_1_zp.ptr<int8_t>(), 1));
                constParams.blobs.push_back(blob);
                ...
                layerParams.set("coeff", DictValue::arrayReal(coeffs.data(),
                                                              coeffs.size()));
                ...
                blob.convertTo(blob_dequantized, CV_32F, inp_scales[1],
                               -(inp_scales[1] * inp_zps[1]));
                layerParams.blobs.push_back(blob_dequantized);
                layerParams.set(
                    "input_scales",
                    DictValue::arrayReal(inp_scales.data(), inp_scales.size()));
            }
        }
    } else if (outShapes[node_proto.input(0)] ==
               outShapes[node_proto.input(3)]) {
        layerParams.type = "EltwiseInt8";
        layerParams.set("operation", op);
        layerParams.set("coeff",
                        DictValue::arrayReal(coeffs.data(), coeffs.size()));
        layerParams.set("offset", offset);
    } else {
        layerParams.type = "ScaleInt8";
        layerParams.set("bias_term", op == "sum");
    ...
    layerParams.set("input_zeropoints",
                    DictValue::arrayInt(inp_zps.data(), inp_zps.size()));
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseQLeakyRelu(LayerParams& layerParams,
                                   const opencv_onnx::NodeProto& node_proto) {
...
void ONNXImporter::parseQSigmoid(LayerParams& layerParams,
                                 const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() == 5);
...
void ONNXImporter::parseQAvgPool(LayerParams& layerParams,
                                 const opencv_onnx::NodeProto& node_proto) {
    CV_Assert(node_proto.input_size() == 5);
    float inp_sc = getBlob(node_proto, 1).at<float>(0);
    int8_t inp_zp = getBlob(node_proto, 2).at<int8_t>(0);
    ...
    layerParams.set("pool", "ave");
    layerParams.set("global_pooling",
                    node_proto.op_type() == "QLinearGlobalAveragePool");
    layerParams.set("multiplier", inp_sc / out_sc);
    layerParams.set("input_zeropoint", inp_zp);
    addLayer(layerParams, node_proto);
}

void ONNXImporter::parseQConcat(LayerParams& layerParams,
                                const opencv_onnx::NodeProto& node_proto_) {
    opencv_onnx::NodeProto node_proto = node_proto_;
...
void ONNXImporter::buildDispatchMap_ONNX_AI(int opset_version) {
    ...
    dispatch["GlobalAveragePool"] = dispatch["GlobalMaxPool"] =
        dispatch["ReduceMean"] = dispatch["ReduceSum"] = dispatch["ReduceMax"] =
            &ONNXImporter::parseReduce;
    dispatch["Slice"] = &ONNXImporter::parseSlice;
    dispatch["Split"] = &ONNXImporter::parseSplit;
    dispatch["Add"] = dispatch["Sum"] = dispatch["Sub"] =
        &ONNXImporter::parseBias;
    ...
    dispatch["Equal"] = dispatch["Greater"] = dispatch["Less"] =
        &ONNXImporter::parseCompare;
    dispatch["PRelu"] = &ONNXImporter::parsePRelu;
    dispatch["LRN"] = &ONNXImporter::parseLRN;
    dispatch["InstanceNormalization"] =
        &ONNXImporter::parseInstanceNormalization;
    ...
    dispatch["ConstantFill"] = dispatch["ConstantOfShape"] =
        &ONNXImporter::parseConstantFill;
    ...
    // ai.onnx: opset 10+
    dispatch["QuantizeLinear"] = dispatch["DequantizeLinear"] =
        &ONNXImporter::parseQuantDequant;
...
void ONNXImporter::buildDispatchMap_COM_MICROSOFT(int opset_version) {
    ...
    dispatch["QLinearAdd"] = dispatch["QLinearMul"] =
        &ONNXImporter::parseQEltwise;
    dispatch["QLinearAveragePool"] = dispatch["QLinearGlobalAveragePool"] =
        &ONNXImporter::parseQAvgPool;
...
Net readNetFromONNX(const std::vector<uchar>& buffer) {
    return readNetFromONNX(reinterpret_cast<const char*>(buffer.data()),
                           buffer.size());
}
